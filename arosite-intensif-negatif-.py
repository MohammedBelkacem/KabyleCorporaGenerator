import random
suffixes_COI=['yi','iyi','ak','am','as','aɣ','awen','awent','akent','aken','asen','asent','k','m','s','ɣ','wen','went','kent','ken','sen','sent','yak','yam','yas','yaneɣ','yaɣ','yantneɣ','yawen','yawent','yakent','yaken','yasen','yasent']
...
words=["ur igellu uara"]
#complement=["s lebɣi", "s lfeṛḥ","ma akka", "s waṭas", "azekka", "s wawal","axir","akken","iḍ kamel","ass kamel"]
##for i in words:
...
for i in sentences:
    for j in i:
        #x=random.randrange(len(complement))
        #print(x)
        print(j)
        #+" "+complement[x]+'.')
